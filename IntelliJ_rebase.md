...
## 자신의 깃허브계정에서 Clone해올 Repository를 선택한다.(하단Directory는 Clone해올 Repository의 저장경로)
...
## 프로젝트를 우클릭후 Git에 Merge Remotes...를 눌러 Repository를 가져온다.(자신의 저장소가 아님)
